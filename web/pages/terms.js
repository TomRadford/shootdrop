...
const TermsPage = () => (
  <>
    <Head>
      <title>Terms & privacy policy | ShootDrop</title>
    </Head>
    <Layout>
      <div className="mx-4 my-16 md:my-4">
        <h2 className="text-xl">
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to ShootDrop!</p>
        ...
        <p>
          ...
          not continue to use ShootDrop if you do not agree to take all of the
        ...
        <p>
          Unless otherwise stated, ShootDrop and/or its licensors own the
          intellectual property rights for all material on ShootDrop. All
          intellectual property rights are reserved. You may access this from
          ShootDrop for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from ShootDrop</li>
          <li>Sell, rent or sub-license material from ShootDrop</li>
          <li>Reproduce, duplicate or copy material from ShootDrop</li>
          <li>Redistribute content from ShootDrop</li>
        </ul>
        ...
        <p>
          ...
          opinions and information in certain areas of the website. ShootDrop
          ...
          opinions of ShootDrop, its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, ShootDrop shall
        ...
        <p>
          ShootDrop reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant ShootDrop a non-exclusive license to use, reproduce,
          edit and authorize others to use, reproduce and edit any of your
          Comments in any and all forms, formats or media.
        </p>

        <h3>
          <strong>Hyperlinking to our App</strong>
        </h3>
        ...
        <p>
          ...
          the hyperlink compensates the absence of ShootDrop; and (d) the link
        ...
        <p>
          ...
          are interested in linking to our App, you must inform us by sending an
          e-mail to ShootDrop. Please include your name, your organization name,
          contact information as well as the URL of your site, a list of any
          URLs from which you intend to link to our App, and a list of the URLs
        ...
        <p>
          No use of ShootDrop's logo or other artwork will be allowed for
        ...
        <p>
          ...
          links to our App upon request. We also reserve the right to amen these
        ...
        <h3>
          <strong>Removal of links from our App</strong>
        </h3>
        ...
        <h1 className="text-xl font-bold">Privacy Policy for ShootDrop</h1>

        <p>
          At ShootDrop, one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information
          that is collected and recorded by ShootDrop and how we use it.
        </p>
        ...
        <p>
          ShootDrop follows a standard procedure of using log files. These files
        ...
        <p>
          ...
          advertising partners of ShootDrop.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Beacons that are used in their respective
          advertisements and links that appear on ShootDrop. They automatically
        ...
        <p>
          Note that ShootDrop has no access to or control over these cookies
        ...
        <p>
          ShootDrop's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ShootDrop does not knowingly collect any Personal Identifiable
        ...
        <p>
          ...
          shared and/or collect in ShootDrop. This policy is not applicable to
